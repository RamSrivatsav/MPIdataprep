# -*- coding: utf-8 -*-
"""
Created on Fri Sep 21 13:00:30 2018
...
parser.add_argument("--cam_dir", type=str, required=True, help="where the cam parameters are stored")
parser.add_argument("--dataset_name", type=str, required=True, choices=["kitti_raw_eigen", "kitti_raw_stereo", "kitti_odom", "cityscapes","MPI_Sintel"])
